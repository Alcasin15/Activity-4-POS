...
public class qframe extends javax.swing.JFrame {
    ...
    public qframe() {
       ...
       void setproduct(String producct){
           this.product = producct;
       }
       ...
       void setdproduct(String product){
       ...
       void setsubtotal(Double subt){
           this.subtotal = getsubtotal() + (getprice() * getquantity());
       }
       ...
       void displayproduct(String Product){
       jTextArea1.setText(jTextArea1.getText() + Product);
       }
    /**
     * 
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ballpen", "Pencil", "Yellow Pad", "Notepad" }));
...
//        String Strand = jComboBox1.getSelectedItem().toString();
//        jTextArea1.setText(Strand);
